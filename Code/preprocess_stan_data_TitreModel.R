...
sero0 <- sero0[,list(count=.N),by=c("age","sample_year","id1","DV1", "DV2","DV3","DV4","sampleID")]
...
titre_matrix <- matrix(-99,nrow=dim(sero0)[1],ncol=4)
for (i in 1:dim(sero0)[1]){
  titre_matrix[i,] <- sero0[i,c(log(DV1-min(dataall$DV1)+1.01),log(DV2-min(dataall$DV2)+1.01),log(DV3-min(dataall$DV3)+1.01),log(DV4-min(dataall$DV4)+1.01))]
}
...
stan_data$titre0 <- t(titre_matrix)
stan_data$city_index0 <- sero0$cityindex

##### seropositive:1 #####
sero1 <- subset(dataall,status==1)
sero1 <- sero1[,list(count=.N),by=c("age","sample_year","d1_status","d2_status","d3_status","d4_status","id1","DV1", "DV2","DV3","DV4","sampleID")]
...
titre_matrix <- matrix(-99,nrow=dim(sero1)[1],ncol=4)
for (i in 1:dim(sero1)[1]){
  titre_matrix[i,] <- sero1[i,c(log(DV1-min(dataall$DV1)+1.01),log(DV2-min(dataall$DV2)+1.01),log(DV3-min(dataall$DV3)+1.01),log(DV4-min(dataall$DV4)+1.01))]
}
...
stan_data$titre1 <- t(titre_matrix)
stan_data$decay_length1 <- t(decay_length_matrix)
stan_data$city_index1 <- sero1$cityindex

##### seropositive:2 #####
sero2 <- subset(dataall,status==2)
sero2 <- sero2[,list(count=.N),by=c("age","sample_year","d1_status","d2_status","d3_status","d4_status","id1","DV1", "DV2","DV3","DV4","sampleID")]
...
titre_matrix <- matrix(-99,nrow=dim(sero2)[1],ncol=4)
for (i in 1:dim(sero2)[1]){
  titre_matrix[i,] <- sero2[i,c(log(DV1-min(dataall$DV1)+1.01),log(DV2-min(dataall$DV2)+1.01),log(DV3-min(dataall$DV3)+1.01),log(DV4-min(dataall$DV4)+1.01))]
}
...
stan_data$titre2 <- t(titre_matrix)
...
sero3 <- sero3[,list(count=.N),by=c("age","sample_year","d1_status","d2_status","d3_status","d4_status","id1","DV1", "DV2","DV3","DV4","sampleID")]
...
titre_matrix <- matrix(-99,nrow=dim(sero3)[1],ncol=4)
for (i in 1:dim(sero3)[1]){
  titre_matrix[i,] <- sero3[i,c(log(DV1-min(dataall$DV1)+1.01),log(DV2-min(dataall$DV2)+1.01),log(DV3-min(dataall$DV3)+1.01),log(DV4-min(dataall$DV4)+1.01))]
}
...
titre_matrix <- matrix(-99,nrow=dim(sero4)[1],ncol=4)
for (i in 1:dim(sero4)[1]){
  titre_matrix[i,] <- sero4[i,c(log(DV1-min(dataall$DV1)+1.01),log(DV2-min(dataall$DV2)+1.01),log(DV3-min(dataall$DV3)+1.01),log(DV4-min(dataall$DV4)+1.01))]
}
...
stan_data$titre4 <- t(titre_matrix)
stan_data$decay_length4 <- t(decay_length_matrix)
stan_data$city_index4 <- sero4$cityindex

stan_data$ymax <- 2.081

#saveRDS(stan_data,"stan_data_TitreModel.rds")
